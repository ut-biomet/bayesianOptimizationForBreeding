...
optP <- list(
  ...
  propose.points = 5, # number of points evaluated at each iteration
  nCpusProposePoints = 5, # number of core to use for evaluating the points at each iteration
  totalIter = 10, # total number of iteration
  # time.budget = 60*30, # total time available for the optimization
  initTrainSize = 7, # initial training data size (must be at least the number of dimension)
  funEval = 1, # see below
