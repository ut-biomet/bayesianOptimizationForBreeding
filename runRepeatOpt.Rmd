...
repRes_nRep <- 100 # number of opt result evaluations   #CHANGE HERE
repRes_nCpus <- 16 # number of core to use for opt result evaluations
...
Fixed.nNewFALSE-Fixed.SelIntTRUE-(InitPop1)
simSetupFolder <- paste0(simSetupFolder, "/", date,"_Fixed.nNew-",Fixed.nNew,"_Fixed.SelInt-",Fixed.SelInt, "_(InitPop-",StartPop_k,")")
optSetupFolder <- paste0(optSetupFolder, "/", date,"_Fixed.nNew-",Fixed.nNew,"_Fixed.SelInt-",Fixed.SelInt, "_(InitPop-",StartPop_k,")")
optResultFolder <- paste0(optResultFolder, "/", date,"_Fixed.nNew-",Fixed.nNew,"_Fixed.SelInt-",Fixed.SelInt, "_(InitPop-",StartPop_k,")")
repResultFolder <- paste0(repResultFolder, "/", date,"_Fixed.nNew-",Fixed.nNew,"_Fixed.SelInt-",Fixed.SelInt, "_(InitPop-",StartPop_k,")")
...
optP <- list(
  ...
  propose.points = 16, # number of points evaluated at each iteration
  nCpusProposePoints = 16, # number of core to use for evaluating the points at each iteration
  totalIter = 1, # total number of iteration
